...
// Files to upload
const files = [
    { src: 'vidismart-competitve-analysis-2026.html', dest: 'vidismart-competitve-analysis-2026.html' },
    { src: 'VIDIMAIL_COMPETITIVE_ANALYSIS_REPORT.html', dest: 'VIDIMAIL_COMPETITIVE_ANALYSIS_REPORT.html' },
];
...
async function main() {
    console.log('🚀 Uploading vidismart.com files...\n');
    ...
    console.log('\n✨ Upload complete!');
    console.log(`\n📍 URLs:`);
    console.log(`   https://vidismart.com/vidismart-competitve-analysis-2026.html`);
    console.log(`   https://cdn.vidi.news/VIDIMAIL_COMPETITIVE_ANALYSIS_REPORT.html`);
}
