...
// File to upload
const files = [
    { src: 'vidibuzz.agent.html', dest: 'vidibuzz.agent.html' },
];
...
async function main() {
    console.log('🚀 Uploading vidibuzz.agent.html to vidibuzz.com...\n');
    ...
    console.log('\n✨ Upload complete!');
    console.log(`\n📍 URL: https://vidibuzz.com/vidibuzz.agent.html`);
    console.log(`   CDN URL: https://cdn.vidi.news/vidibuzz.agent.html`);
}
