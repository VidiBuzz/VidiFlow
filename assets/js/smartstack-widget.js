...
(function () {
    ...
    const MODELS = {
        vision: [
            { name: 'MiniMax M3',      sub: 'MiniMax',   price: '$0.30/$1.20', ctx: '1M',   note: 'Frontier Omni — best all-round vision' },
            { name: 'MiMo 2.5 Omni',   sub: 'Xiaomi',    price: 'Free / Local',ctx: '512K', note: 'Open-weight · runs on ~8 GB VRAM', local: true },
            { name: 'MiMo 2.5 Pro',    sub: 'Xiaomi',    price: '$0.44/$0.87', ctx: '512K', note: 'Pro vision tier · higher precision' },
            { name: 'Qwen 3.7 Plus',   sub: 'Alibaba',   price: '$0.40/$1.60', ctx: '1M',   note: 'Vision + agentic code in one model' },
            { name: 'GLM-5V Turbo',    sub: 'Zhipu AI',  price: '$1.20/$4.00', ctx: '202K', note: 'Agent-grade visual QA & layout analysis' },
            { name: 'Gemini 3.5 Flash',sub: 'Google',    price: '$1.50/$9.00', ctx: '1M',   note: 'Speed-optimised Omni multimodal' },
        ],
        reasoning: [
            { name: 'Qwen 3.7 Max',    sub: 'Alibaba',   price: '$1.25/$3.75', ctx: '1M',   note: 'ELO 1558 · #1 reasoning benchmark' },
            { name: 'DeepSeek V4 Pro', sub: 'DeepSeek',  price: '$0.435/$0.87', ctx: '1M',   note: 'Frontier reasoning at budget price' },
            { name: 'Claude 4.8 Opus', sub: 'Anthropic', price: '$5.00/$25.00',ctx: '1M',   note: 'Maximum capability · tie-breaker tier' },
            { name: 'GLM-5.1',         sub: 'Zhipu AI',  price: '$0.98/$3.08', ctx: '200K', note: 'Deep recursive debugging & tool use' },
            { name: 'Kimi K 2.6',      sub: 'Moonshot',  price: '$0.684/$3.42', ctx: '256K',   note: '256K context · full repo ingestion' },
        ],
        code: [
            { name: 'Qwen 3.7 Max',      sub: 'Alibaba',   price: '$1.25/$3.75', ctx: '1M',   note: '#1 Code Arena · coding superagent' },
            { name: 'DeepSeek V4 Pro',   sub: 'DeepSeek',  price: '$0.435/$0.87', ctx: '1M',   note: 'Best value frontier coder' },
            { name: 'Qwen 3.7 Plus',     sub: 'Alibaba',   price: '$0.40/$1.60', ctx: '1M',   note: 'Agentic · vision-informed layouts' },
            { name: 'Claude 4.6 Sonnet', sub: 'Anthropic', price: '$3.00/$15.00',ctx: '1M',   note: 'Premium code · excellent tool use' },
            { name: 'Kimi K 2.6',        sub: 'Moonshot',  price: '$0.684/$3.42', ctx: '256K',   note: 'Long-context planning & refactors' },
        ...
        image: [
            ...
            { name: 'FLUX.1 Pro',     sub: 'Black Forest', price: '$0.03 / img',note: 'Commercial grade · ComfyUI compatible' },
            { name: 'Ideogram 3.0',   sub: 'Ideogram',   price: '$0.05 / img',  note: 'Best-in-class text rendering in images' },
            { name: 'SD 3.5 Large',   sub: 'Stability',  price: 'Free (OSS)',   note: 'Open source · full fine-tuning ecosystem' },
            { name: 'Imagen 3',       sub: 'Google',     price: 'Vertex AI',    note: 'Photorealism · rich detail + text render' },
        ],
        local: [
            { name: 'Qwen 3.6 27B',  sub: 'Alibaba', price: 'Free', ctx: '128K', note: 'Q4_K_M · ~17 GB · fits RTX 4090 (24 GB)', local: true },
            { name: 'MiMo 2.5 Omni', sub: 'Xiaomi',  price: 'Free', ctx: '512K', note: 'Omni vision+audio+text · ~8 GB VRAM', local: true },
        ],
    };

    const DEFAULT_STACK = {
        vision: 'MiMo 2.5 Omni', reasoning: 'Qwen 3.7 Max',
        code:   'DeepSeek V4 Pro', video: 'Wan 2.7 T2V',
        image:  'FLUX.1 Pro', local: 'Qwen 3.6 27B',
    };
