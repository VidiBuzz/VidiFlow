...
(function () {
    ...
    const MODELS = {
        ...
        reasoning: [
            { name: 'Qwen 3.7 Max',    sub: 'Alibaba',   price: '$1.25/$3.75', ctx: '128K', note: 'ELO 1558 · #1 reasoning benchmark' },
            { name: 'DeepSeek V4 Pro', sub: 'DeepSeek',  price: '$0.44/$0.87', ctx: '1M',   note: 'Frontier reasoning at budget price' },
            ...
            { name: 'Kimi K 2.6',      sub: 'Moonshot',  price: '$0.68/$3.42', ctx: '2M',   note: '2M context · full repo ingestion' },
        ],
        code: [
            { name: 'Qwen 3.7 Max',      sub: 'Alibaba',   price: '$1.25/$3.75', ctx: '128K', note: '#1 Code Arena · coding superagent' },
            { name: 'DeepSeek V4 Pro',   sub: 'DeepSeek',  price: '$0.44/$0.87', ctx: '1M',   note: 'Best value frontier coder' },
            ...
            { name: 'Kimi K 2.6',        sub: 'Moonshot',  price: '$0.68/$3.42', ctx: '2M',   note: 'Long-context planning & refactors' },
