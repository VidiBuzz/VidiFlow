...
const FILES_TO_UPLOAD = [
    { src: 'smartchannelcx.tech.html', dest: 'smartchannelcx.tech.html', type: 'text/html' },
    { src: 'smartchannelcx.html', dest: 'smartchannelcx.html', type: 'text/html' },
...
async function run() {
    console.log('Pushing Technical Page Update...');
